    ...
    <>
      ...
      <Collapsible defaultOpen>
        ...
        <CollapsibleContent className="flex flex-col gap-2 px-2 pb-3">
          ...
          <Select
            ...
            onValueChange={(v) =>
              setSelectedCollectionId(v === "__none__" ? "" : v)
            }
          >
          ...
          {libraryScope === "collection" ? (
            <Button
              ...
              disabled={
                !selectedCollectionId || selectedLibraryItemIds.length === 0
              }
            >
            ...
            <div className="flex flex-col gap-1">
              ...
              <Button
                ...
                disabled={
                  !selectedCollectionId || filteredLibraryItems.length === 0
                }
              >
            ...
            {collections.length === 0 ? (
              ...
              collections.map((c) => (
                <button
                  ...
                  className={cn(
                    navItemCls,
                    selectedCollectionId === c.id && navItemActiveCls,
                  )}
          ...
          >
            ...
            <div className="flex gap-1">
              <Select
                ...
                onValueChange={(v) =>
                  setCollectionVisibility(v as "private" | "public")
                }
              >
      ...
      <Collapsible defaultOpen>
        ...
        <CollapsibleContent className="flex flex-col gap-2 px-2 pb-3">
          ...
          <Select
            ...
            onValueChange={(v) =>
              setLibraryTypeFilter(v as "all" | "url" | "media")
            }
          >
            <SelectTrigger className="h-8 text-xs">
          ...
          <div className="flex flex-col gap-1">
            ...
            />
            <label className="text-[10px] text-muted-foreground uppercase tracking-wide mt-0.5">
              To
            </label>
            <input
              type="date"
      ...
      <Collapsible defaultOpen={false}>
        ...
        <CollapsibleContent className="flex flex-col gap-2 px-2 pb-3">
          {/* Taxonomy filter */}
          <Select
            value={libraryTaxonomyFilter}
            onValueChange={setLibraryTaxonomyFilter}
          >
            <SelectTrigger className="h-8 text-xs">
          ...
          <datalist id="library-taxonomy-terms">
            {visibleTaxonomySuggestions.map((t) => (
              <option key={t} value={t} />
            ))}
            {availableTaxonomyFacets.map((t) => (
              <option key={`facet-${t}`} value={t} />
            ))}
          </datalist>
          ...
          <div className="flex flex-col gap-1">
            ...
            <Button
              ...
              disabled={
                !taxonomyQuickInput.trim() || filteredLibraryItems.length === 0
              }
            >
          ...
          {visibleTaxonomySuggestions.length > 0 && (
            <div className="flex flex-wrap gap-1">
              <span className="text-[10px] font-semibold text-muted-foreground w-full">
                Suggested:
              </span>
